...
export function Footer() {
  ...
  return (
    <footer className="bg-background border-t border-white/4 py-8 select-none">
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-8">
            {socialLinks.map((link) => (
              <a
                ...
                className="font-mono text-[10px] tracking-[0.2em] text-white/40 uppercase transition-colors duration-300 hover:text-white"
              >
                {link.label}
              </a>
            ))}

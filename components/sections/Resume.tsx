...
export default function Resume() {
  ...
  return (
    <section id="resume" className="py-24 md:py-36 bg-[#050505] border-t border-white/2">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mt-14 md:mt-20 items-stretch">
          ...
          <div className="md:col-span-7 flex flex-col justify-between p-6 md:p-8 bg-[#0d0d0d] border border-white/4 rounded-sm">
            <div>
            ...
            {edu.details && (
              <div className="pt-4 border-t border-white/3 text-[11px] font-mono leading-relaxed text-white/40">
                {edu.details}
              </div>
            )}
          </div>
          ...
          <div className="md:col-span-5 flex flex-col justify-center items-center p-6 md:p-8 bg-white/1 border border-dashed border-white/8 rounded-sm text-center">
            <div className="w-12 h-12 rounded-full bg-white/2 border border-white/4 flex items-center justify-center mb-4 text-white/50 group-hover:text-white transition-colors">
            ...
            <p className="text-white/40 text-[11px] leading-relaxed mb-6 max-w-50 font-sans">
